...
["pappes_web_utility.base", "package:pappes_web_utility/src/pappes_web_utility_base.dart", , E, {
  "^": "",
  MyHtml_retargetAllHrefs: function(htmlDoc, target) {
    var t1, t2;
    t1 = $.get$log();
    t2 = htmlDoc.nodeValue;
    t1.info$1("Function : retargetAllHrefs, Parameters : {[htmlDoc," + (t2 == null ? J.Interceptor.prototype.toString$0.call(C.HtmlDocument_methods, htmlDoc) : t2) + "][target," + target + "]}");
    t2 = W._FrozenElementList$_wrap(htmlDoc.querySelectorAll("a"), null);
    t2.forEach$1(t2, new E.MyHtml_retargetAllHrefs_closure(target));
    t1.fine$1("Function : retargetAllHrefs, Return : void");
  },
  MyHtml_retargetAllHrefs_closure: {
    "^": "Closure:9;target_0",
    call$1: function(e) {
      var t1 = $.get$log();
      t1.finest$1("Function : retargetAllHrefs, old : " + H.S(J.get$attributes$x(e)._element.getAttribute("target")));
      e.setAttribute("target", this.target_0);
      t1.finest$1("Function : retargetAllHrefs, new : " + H.S(e.getAttribute("target")));
    }
  }
}],
["", "retarget_url_self.dart", , E, {
  "^": "",
  main: function() {
    E.MyHtml_retargetAllHrefs(document, "_self");
  }
},
1],
]);
