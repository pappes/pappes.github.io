...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  _JsDeserializer: {
    ...
    deserializeFunction$1: function(list) {
      return H.IsolateNatives__getJSFunctionFromName(J.$index$as(list, 1));
    }
  },
  _JsVisitedMap: {
    "^": "Object;tagged",
  ...
  _Future__propagateToListeners_handleWhenCompleteCallback: {
    ...
    call$0: function() {
      ...
      if (!!J.getInterceptor(t2).$isFuture) {
        result = this.listener_9.get$result();
...
["logging", "package:logging/logging.dart", , N, {
  ...
  Logger: {
    ...
    Logger$_internal$3: function($name, $parent, children) {
      var t1 = this.parent;
      if (t1 != null)
        t1.get$_children().$indexSet(0, this.name, this);
    },
...
["", "set_log_level_fine.dart", , U, {
  "^": "",
  main: [function() {
    $.hierarchicalLoggingEnabled = true;
    var t1 = $.get$log();
    t1.set$level(C.Level_FINE_500);
    t1.get$onRecord().listen$1(new U.main_closure());
  }, "call$0", "main$closure", 0, 0, 9],
  main_closure: {
    "^": "Closure:18;",
    call$1: function(rec) {
      P.print(rec.get$level().name + ": " + H.S(rec.get$time()) + ": " + H.S(rec.get$message()));
    }
  }
},
1],
