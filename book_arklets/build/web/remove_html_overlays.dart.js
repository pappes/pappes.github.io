...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|DOMImplementation|MediaError|MediaKeyError|Navigator|PositionError|Range|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.async", "dart:async", , P, {
  ...
  _Completer: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 40, 16, 17, 18]
  },
  _AsyncCompleter: {
    "^": "_Completer;future",
...
["", "remove_html_overlays.dart", , T, {
  ...
  main: [function() {
    ...
    t2 = $.get$log();
    t3 = t1.nodeValue;
    t2.info$1("Function : removeAllOverlays, Parameters : {[htmlDoc," + (t3 == null ? J.Interceptor.prototype.toString$0.call(C.HtmlDocument_methods, t1) : t3) + "]}");
    E.MyHtml__stripDownPage(t1);
    iFrames = W._FrozenElementList$_wrap(t1.querySelectorAll("iframe"), null);
    ...
    new E.MyIFrame(C.NodeList_methods.get$last(iFrames._nodeList), t1, null).makeProminant$1(E.MyHtml__stripDownPage$closure());
    t2.fine$1("Function : removeAllOverlays, Return : void");
